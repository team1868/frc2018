...
public:
	...
	bool GetElevatorBottomLimitSwitch(); //returns true if open and false if closed

	bool GetElevatorTopLimitSwitch();
...
private:
	...
	DigitalInput *elevatorBottomLimitSwitch_;
	DigitalInput *elevatorTopLimitSwitch_;
