...
void CubeInSwitchMode::CreateQueue(string gameData, AutoMode::AutoPositions pos) {
	...
	case kLeft:
		...
		if (switchSide == 'L') {
			printf("Left switch: ");
			autoSequence = "d 12.0 t 90.0 d 1.81"; // TODO outtake
		} else if (switchSide == 'R') {
			printf("Right switch: ");
			autoSequence = "d 17.56 t 90.0 d 17.6 t -118.81 d 1.61"; // TODO outtake
		}
		break;
	case kMiddle:
		...
		if (switchSide == 'L') {
			printf("Left Switch: ");
			autoSequence = "d 2.58 t -90.0 d 3.31 t 0.0 d 6.08"; // TODO outtake
		} else if (switchSide == 'R') {
			printf("Right Switch: ");
			autoSequence = "d 2.583 t 90.0 d 3.02 t 0.0 d 6.08"; // TODO outtake
		}
		break;
	case kMiddleRight:
		printf("Middle Right: ");
	...
	case kFarRight:
		...
		if (switchSide == 'L') {
			printf("Left Switch: ");
			autoSequence = "d 17.56 t -90 d 17.6 t 118.81 d 1.61"; // TODO outtake
		} else if (switchSide == 'R') {
			printf("Right Switch: ");
			autoSequence = "d 12.5 t -90.0 d 1.81"; // TODO outtake
		}
		break;
	case kIni:
