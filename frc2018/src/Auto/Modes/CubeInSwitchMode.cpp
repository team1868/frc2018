...
void CubeInSwitchMode::CreateQueue(string gameData, AutoMode::AutoPositions pos) {
	...
	case kLeft:
		...
		if (switchSide == 'L') {
			printf("Left switch: ");
			autoSequence = "p d 12.0 e 1.8 t 90.0 t 90.0 d 2.3 w 0 o";	// turn twice to get pivot on point
			...
			if (scaleSide == 'L') {
				...
				printf("Right scale: ");
				autoSequence = "d 17.56 t 90.0 t 90.0";
			}
//			autoSequence = "d 17.56 t 90.0 t 90.0 p d 17.45 e 1.8 t -135.0 t -135.0 d 5.3 w 0 o"; // TODO test on practice
	...
	case kMiddle:
		...
		if (switchSide == 'L') {
			printf("Left Switch: ");
			autoSequence = "d 2.0 t -90.0 t -90.0 d 3.6 t 0.0 t 0.0 p e 1.8 d 6.2 w 0 o";
					//"d 3.0 t -40.0 t -40.0 p e 1.8 d 8.2 w 0 o";
					//"d 2.0 t -90.0 t -90.0 d 3.6 t 0.0 t 0.0 p e 1.8 d 6.8 w 0 p d 1.1 o";
		} else if (switchSide == 'R') {
			printf("Right Switch: ");
			autoSequence = "d 2.0 t 90.0 t 90.0 d 3.67 t 0.0 t 0.0 p e 1.8 d 6.2 w 0 o"; // was d 6.67, 3.67
//"d 2.0 t 90.0 t 90.0 d 3.67 t 0.0 t 0.0 p e 1.8 d 6.8 w 0 p d 1.1 o"; // crashed
	...
	case kFarRight:
		...
		if (switchSide == 'L') {
			printf("Left Switch: ");
			autoSequence = "d 17.56 t -90.0 t -90.0 p d 19.7 e 1.8 t 135.0 t 135.0 d 5.3 w 0 o"; // TODO outtake, test
		} else if (switchSide == 'R') {
			printf("Right Switch: ");
			autoSequence = "p d 11.8 e 1.8 t -90.0 t -90.0 d 17.45 w 0 o"; // TODO outtake, test
		}
		break;
	case kIni:
